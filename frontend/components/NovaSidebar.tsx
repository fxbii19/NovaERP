...
const gruppen: Gruppe[] = [
  ...
  { id: "konfektion", name: "Konfektion", href: "/qualitaet", icon: ClipboardCheck, bereich: "prozesse", modul: "konfektion", kinder: [{ name: "Übersicht", href: "/qualitaet" }, { name: "Qualitätsprüfung", href: "/qualitaet/pruefungen" }, { name: "Prüfaufträge", href: "/qualitaet/pruefauftraege" }, { name: "Freigaben", href: "/qualitaet/freigaben" }, { name: "Sperrbestand", href: "/qualitaet/sperrbestand" }, { name: "Konfektionsaufträge", href: "/qualitaet/konfektion" }, { name: "Konfektionäre", href: "/qualitaet/konfektionaere" }] },
  ...
  { id: "sheets", name: "NOVA Sheets", href: "/nova-sheets", icon: FileSpreadsheet, bereich: "zusammenarbeit" },
