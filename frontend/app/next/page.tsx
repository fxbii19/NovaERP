...
type DashboardDaten = {
  ...
  umsatz: {
    versendetHeute: number;
    bezahltHeute: number;
    sendungen: Array<{ id: number; versandnummer: string; auftragsnummer: string; kunde: string; warenwert: number; versendetAm: string | null; versendetVon: string | null; lieferscheinnummer: string | null; rechnungId: number | null; rechnungsnummer: string | null }>;
    zahlungen: Array<{ id: number; rechnungId: number; rechnungsnummer: string; kunde: string; betreff: string; betrag: number; zahlungsart: string; referenz: string | null; gebuchtAm: string; gebuchtVon: string | null }>;
  } | null;
